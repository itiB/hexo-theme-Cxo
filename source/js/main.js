!function(e){
    ...
    o.t=function(e,t){
        ...
        for(var n in e)
            o.d(r,n,function(t){return e[t]}.bind(null,n));
        return r
    },
    o.n=function(e){
...
([
    ...
    function(e,t,o){
        ...
        t.default=function(){
            (!sessionStorage.getItem("profile")||sessionStorage.getItem("profile")&&"true"===sessionStorage.getItem("profile"))&&$("#cxo-profile").removeClass("profile-close"),
            0!==$(document).scrollTop()&&$("#go-up").removeClass("chose"),
            $(".profile-avatar>i").on("click",function(e){
                var t=$(this).parents("#cxo-profile");
                t&&!t.hasClass("profile-close")?(t.addClass("profile-close"),sessionStorage.setItem("profile","false")):t&&t.hasClass("profile-close")&&(t.removeClass("profile-close"),
    ...
    function(e,t,o){
        ...
        t.default=function(){
            ...
            function g(u){
                ...
                1===g?(e.css("top",-m+"px"),a.addClass("no-visible")):-1===g&&(e.css("top",0),a.removeClass("no-visible")),
                ...
                d&&(1===h?(o.css("position","fixed"),o.css("top","0")):-1===h&&(o.css("position","absolute"),o.css("top",r)),function(e,t,o){var r=$(window).height(),i=void 0;i=(i=e<n?0:(e-t)/(o-r)*100)>=100?100:i,s[0].style.width=i+"%"}(u,v,p),function(e){if(d){var t="";$("#post").find("h1,h2,h3,h4,h5,h6").each(function(){var o=$(this);o.offset().top<e&&(t="#"+o.attr("id"))});var o=$(".toc-link.active");if(t&&o.attr("href")!==t){$(".toc-link").removeClass("active");var r=$('.toc-link[href="'+t+'"]');r.addClass("active"),r.parents(".toc-child").siblings(".toc-link").addClass("active")}}}(u))
            }
            $(document).on("scroll",function(){g($(document).scrollTop())})
        }
    },
